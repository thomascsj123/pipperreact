      ...
      <div className="columns-container">
        ...
        <div className="column2">
            ...
            <div className="border-bottom">
              <div className="mx-5 my-3">
                <form id="student-form">
                  ...
                  <input name="username" id="username" className="form-control" /><br />
                  <label htmlFor="text">Text</label><br />
                  <textarea id="text" className="form-control mb-2" rows="2" maxLength="255"></textarea>

                  <div className="d-flex justify-content-between align-items-center">
                    <small className="counter"><span id="CharCount">0</span>/255</small>
                    <button type="submit" className="btn-post rounded-pill">Pip</button>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div className="load-more-container">
            <button id="vis-mere" className="rounded-pill knap load-more mt-4 mb-4">Load more</button>
          </div>
        </div>
